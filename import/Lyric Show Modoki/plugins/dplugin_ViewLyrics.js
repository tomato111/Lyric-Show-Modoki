pl = {
    ...
    label: prop.Panel.Lang == 'ja' ? '歌詞検索: ViewLyrics (no save)' : 'Download Lyrics: ViewLyrics (no save)',
    author: 'tomato111',
    ...
    onCommand: function (isAutoSearch) { // プラグインのメニューをクリックすると呼び出される
        ...
        function onLoaded(request, depth, file) {
            ...
            if (depth === 0) {
                ...
                Array.prototype.push.apply(_this.results, fileinfo);
                if (isAutoSearch) {
